...
// DeterministicInstanceID returns a stable id for (spec, cfg) using sha256 of canonical JSON.
...
// Release (no Pre) is considered greater than prerelease with same numbers.
