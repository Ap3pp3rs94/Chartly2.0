...
type DLQRecord struct {
	...
	// Original envelope metadata/body. Payload may be present (bounded by queue contract)
	// but backends may store separately.
	...
	// RecordHash is optional; can be computed via StableHash()
	// over the normalized record.
...
// It does NOT include RecordID (backend may assign)
// and excludes RecordHash itself.
