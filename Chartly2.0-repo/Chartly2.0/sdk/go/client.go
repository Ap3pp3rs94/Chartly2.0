...
func NewClient(baseURL string) *Client {
    ...
    return &Client{
        ...
        StaticHeaders:    map[string]string{},
        Propagator:       telemetry.NopPropagator{},
    }
}
...
// Health calls GET /health and returns the raw body (bounded)
// for display/debug.
...
// Ready calls GET /ready and returns the raw body (bounded)
// for display/debug.
// It does not assume a specific response schema.
...
func (c *Client) doRaw(ctx context.Context, method, path string, body any, opts ...RequestOption) ([]byte, error) {
    ...
    if c.Propagator == nil {
        c.Propagator = telemetry.NopPropagator{}
    }
